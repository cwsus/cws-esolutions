    ...
    do
        ...
        case ${ANSWER} in
            ...
            *)
                ...
                . ${APP_ROOT}/${LIB_DIRECTORY}/validators/validate_service_request.sh -d ${ANSWER} -e;
                RET_CODE=${?};
    ...
    do
        ...
        case ${CONFIRM} in
            [Yy][Ee][Ss]|[Yy])
                ...
                . ${APP_ROOT}/${LIB_DIRECTORY}/runFailoverRequest.sh -r ${INTERNET_TYPE_IDENTIFIER} -d ${ANSWER},${IUSER_AUDIT} -e;
                RET_CODE=${?};
