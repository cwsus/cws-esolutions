...
function generateRNDCKeys
{
    ...
    then
        ...
        then
            ...
            [ -s ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${RNDC_KEY_FILE} | cut -d "/" -f 3).REMOTE ] && rm -rf ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${RNDC_KEY_FILE} | cut -d "/" -f 3).REMOTE;
                ...
                then
                    ...
                    then
                        ...
                        then
                            ...
                            cp -p ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${RNDC_KEY_FILE} | cut -d "/" -f 3) ${NAMED_ROOT}/${RNDC_KEY_FILE};
                            cp -p ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${RNDC_CONF_FILE} | cut -d "/" -f 3) ${NAMED_ROOT}/${RNDC_CONF_FILE};
                            ...
                            then
                                ...
                                ## remove tmp files
                                rm -rf ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${RNDC_KEY_FILE} | cut -d "/" -f 3);
                                rm -rf ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${RNDC_CONF_FILE} | cut -d "/" -f 3);
            ...
            then
                ...
                then
                    ...
                    then
                        ## we're all set here. return the key back to the requestor.
                        ## remove tmp files
                        rm -rf ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${TRANSFER_KEY_FILE} | cut -d "/" -f 3);
                        rm -rf ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${TRANSFER_KEY_FILE} | cut -d "/" -f 3);
            ...
            then
                ...
                then
                    ...
                    then
                        ## we're all set here. return the key back to the requestor.
                        ## remove tmp files
                        rm -rf ${APP_ROOT}/${TMP_DIRECTORY}/$(echo ${DHCPD_KEY_FILE} | cut -d "/" -f 3);
