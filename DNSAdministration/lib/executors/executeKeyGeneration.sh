...
function usage
{
    ...
    printf "${CNAME} - Execute key generation requests";
    printf "Usage: ${CNAME} [ -r request information ] [ -k request information ] [-e] [-h|?]";
    printf " -r    -> Generate new RNDC keys. Requires a comma-delimited information set to execute the request.";
    printf " -k    -> Generate DNSSEC keys. Requires a comma-delimited information set to execute the request.";
