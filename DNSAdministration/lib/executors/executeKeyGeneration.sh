            ...
            then
                ...
                then
                    ...
                    then
                        ...
                        BACKUP_FILE=$(echo ${RNDC_KEY_FILE} | cut -d "/" -f 3).${CHANGE_NUM}.${TARFILE_DATE}.${REQUESTING_USER};
    ...
    then
        ...
        then
            ...
            then
                ...
                ## backup first
                TARFILE_DATE=$(date +"%m-%d-%Y");
                BACKUP_FILE=$(echo ${TRANSFER_KEY_FILE} | cut -d "/" -f 3).${CHANGE_NUM}.${TARFILE_DATE}.${REQUESTING_USER};
    ...
    then
        ...
        then
            ...
            then
                ...
                ## backup first
                TARFILE_DATE=$(date +"%m-%d-%Y");
                BACKUP_FILE=$(echo ${DHCPD_UPDATE_KEY} | cut -d "/" -f 3).${CHANGE_NUM}.${TARFILE_DATE}.${REQUESTING_USER};
