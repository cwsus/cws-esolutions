    ...
    do
        ...
        then
            ...
            then
                ...
                for FILENAME in $(ls -ltr ${NAMED_ROOT}/${NAMED_ZONE_DIR}/${NAMED_MASTER_ROOT}/${UNIT} | awk '{print $9}' | cut -d ":" -f 1-1 | grep -v "[PV]H" | uniq | sed '/ *#/d; /^ *$/d');
                do
                    ...
                    LAST_SERIAL=$(grep "; serial" ${NAMED_ROOT}/${NAMED_ZONE_DIR}/${NAMED_MASTER_ROOT}/${UNIT}/${FILENAME} | awk '{print $1}' | sed '/^$/d');
    ...
    then
        ...
        then
            ...
            do
                ...
                ## loop through the zone files
                for FILENAME in $(ls -ltr ${APP_ROOT}/${TMP_DIRECTORY}/${UNIT} | awk '{print $9}' | cut -d ":" -f 1-1 | uniq | sed '/ *#/d; /^ *$/d');
                do
