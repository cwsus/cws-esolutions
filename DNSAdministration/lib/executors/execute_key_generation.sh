...
function generate_rndc_keys
{
    ...
    ## override normal processing and exit here
    exit ${RETURN_CODE};
}

#===  FUNCTION  ===============================================================
#          NAME:  generate_dnssec_keys
                            ...
                            then
                                ...
                                then
                                    ...
                                    head -${START_LINE_NUMBER} ${NAMED_ROOT}/${NAMED_ZONE_DIR}/${NAMED_MASTER_DIR}/${GROUP_ID}${PROJECT_CODE}/${FILENAME} | \
                                        sed -e "${START_LINE_NUMBER}a \$INCLUDE /var/named/etc/dnssec-keys/xmpl/ksk-foo.com.XMPL.key" \
                                            -e "${START_LINE_NUMBER}a \$INCLUDE /var/named/etc/dnssec-keys/xmpl/zsk-foo.com.XMPL.key" >> ${NAMED_ROOT}/${TMP_DIRECTORY}/${FILENAME};
                                    ...
                                    if [ $(grep -c INCLUDE ${NAMED_ROOT}/${TMP_DIRECTORY}/${FILENAME}) -eq 2 ]
                                    then
