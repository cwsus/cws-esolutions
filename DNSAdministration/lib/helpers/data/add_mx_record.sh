        ...
        then
            ...
            then
                ...
                then
                    ...
                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "PRIORITY->${PRIORITY}";
    ...
    then
        ...
        then
            ...
            then
                ...
                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Printed MX record to ${DC_ZONEFILE_NAME}";
...
while getopts ":b:p:z:i:c:t:a:d:rsh:" OPTIONS 2>/dev/null
do
    case "${OPTIONS}" in
        b)
