...
function add_zone_helper
{
    ...
    do
        ...
        print "\t$(grep add.record.srv.type ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)";
        ...
        then
            ...
            if [ $(${APP_ROOT}/lib/validators/validate_srv_type.sh ${SERVICE_TYPE} ${APP_ROOT}/${ALLOWED_SERVICE_TYPES}) -eq 0 ]
            then
                ...
                do
                    ...
                    print "\t\t\t$(grep plugin.application.name ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                    print "\t$(grep add.record.srv.protocol ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)";
                    print "\t$(grep add.record.srv.valid.protocols ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)";
                    print "\t$(grep system.option.cancel "${SYSTEM_MESSAGES}" | grep -v "#" | cut -d "=" -f 2)\n";
                    ...
                    then
                        ...
                        if [ $(${APP_ROOT}/lib/validators/validate_srv_proto.sh ${SERVICE_PROTO}) -eq 0 ]
                        then
                            ...
                            do
                                ...
                                print "\t\t\t$(grep plugin.application.name ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                print "\t$(grep add.record.alias ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed "s/%RECORD_TYPE%/${RECORD_TYPE}/")";
                                print "\t$(grep system.option.cancel "${SYSTEM_MESSAGES}" | grep -v "#" | cut -d "=" -f 2)\n";
                                ...
                                then
                                    ...
                                    do
                                        ...
                                        print "\t\t\t$(grep plugin.application.name ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                        print "\t$(grep add.record.srv.ttl ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)";
                                        print "\t$(grep add.record.srv.default.ttl ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                        ...
                                        then
                                            ...
                                            then
                                                ...
                                                do
                                                    ...
                                                    print "\t\t\t$(grep plugin.application.name ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                                    print "\t$(grep add.record.priority ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed "s/%RECORD_TYPE%/${RECORD_TYPE}/")";
                                                    ...
                                                    then
                                                        ...
                                                        then
                                                            ...
                                                            do
                                                                ...
                                                                print "\t\t\t$(grep plugin.application.name ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                                                print "\t$(grep add.record.srv.weight ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                                                ...
                                                                then
                                                                    ...
                                                                    then
                                                                        ...
                                                                        do
                                                                            ...
                                                                            print "\t\t\t$(grep plugin.application.name ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                                                            print "\t$(grep add.record.srv.port ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                                                            ...
                                                                            then
                                                                                ...
                                                                                then
                                                                                    ...
                                                                                    do
                                                                                        ...
                                                                                        print "\t\t\t$(grep plugin.application.name ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2)\n";
                                                                                        print "\t$(grep add.record.target ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed "s/%RECORD_TYPE%/${RECORD_TYPE}/")\n";
                                                                                        ...
                                                                                        then
                                                                                            ...
                                                                                            . ${APP_ROOT}/lib/validators/validate_record_target.sh srv ${SERVICE_TARGET};
                                                                                            RET_CODE=${?};
    ...
    local METHOD_NAME="${CNAME}#${0}";
                                                                                            ...
                                                                                            then
                                                                                                ...
                                                                                                . ${APP_ROOT}/lib/helpers/data/add_${RECORD_TYPE}_record.sh -b ${BIZ_UNIT} -p ${SITE_PRJCODE} -z "${SITE_HOSTNAME}" -i ${IUSER_AUDIT} -c ${CHG_CTRL} -t ${RECORD_TYPE} -a ${SERVICE_TYPE},${SERVICE_PROTO},${SERVICE_NAME},${SERVICE_TTL},${SERVICE_PRIORITY},${SERVICE_WEIGHT},${SERVICE_PORT},${SERVICE_TARGET} -r;
                                                                                                RET_CODE=${?};
                                                                                                ...
                                                                                                print "$(grep target.provided.not.valid ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed -e "s/%RECORD_TYPE%/${RECORD_TYPE}/" -e "s/%TARGET%/${SERVICE_TARGET}/")\n";
                                                                                    ...
                                                                                    print "$(grep number.provided.not.valid ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed -e "s/%REQUEST_TYPE%/service port/" -e "s/%REQUEST_NUMBER%/${SERVICE_PORT}/")\n";
                                                                        ...
                                                                        print "$(grep number.provided.not.valid ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed -e "s/%REQUEST_TYPE%/service weight/" -e "s/%REQUEST_NUMBER%/${SERVICE_WEIGHT}/")\n";
                                                            ...
                                                            print "$(grep number.provided.not.valid ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed -e "s/%REQUEST_TYPE%/service priority/" -e "s/%REQUEST_NUMBER%/${SERVICE_PRIORITY}/")\n";
                                                ...
                                                print "$(grep number.provided.not.valid ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed -e "s/%REQUEST_TYPE%/service TTL/" -e "s/%REQUEST_NUMBER%/${SERVICE_TTL}/")\n";
                            ...
                            print "$(grep protocol.not.valid ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed "s/%PROTOCOL%/${SERVICE_PROTO}/")\n";
                ...
                print "$(grep record.type.disallowed ${PLUGIN_CONFIG} | grep -v "#" | cut -d "=" -f 2 | sed "s/%RECORD_TYPE%/${SERVICE_TYPE}/")\n";
...
function add_subdomain_helper
{
    ...
    do
        ...
        then
            ...
            if [ $(${APP_ROOT}/lib/validators/validate_srv_type.sh ${SERVICE_TYPE}) -eq 0 ]
            then
                [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} DEBUG "${METHOD_NAME}" "${CNAME}" "${LINENO}" "SERVICE_TYPE->${SERVICE_TYPE}";
                [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} DEBUG "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Requesting service protocol..";
    ...
    local METHOD_NAME="${CNAME}#${0}";
                                                                                                    ...
                                                                                                    . ${APP_ROOT}/lib/helpers/data/add_${RECORD_TYPE}_record.sh -b ${BIZ_UNIT} -p ${SITE_PRJCODE} -z "${SITE_HOSTNAME}" -i ${IUSER_AUDIT} -c ${CHG_CTRL} -t ${RECORD_TYPE} -a ${SERVICE_TYPE},${SERVICE_PROTO},${SERVICE_NAME},${SERVICE_TTL},${SERVICE_PRIORITY},${SERVICE_WEIGHT},${SERVICE_PORT},${SERVICE_TARGET} -s;
                                                                                                    RET_CODE=${?};
