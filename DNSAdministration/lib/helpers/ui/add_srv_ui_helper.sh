    ...
    do
        ...
        case ${SERVICE_TYPE} in
            [Xx]|[Qq]|[Cc])
                ...
                ;;
            *)
                ${PLUGIN_ROOT_DIR}/lib/validators/validateServiceRecordData.sh type ${SERVICE_TYPE};
                typeset -i RET_CODE=${?};
    ...
    do
        ...
        case ${SERVICE_PROTO} in
            [Xx]|[Qq]|[Cc])
                ...
                ;;
            *)
                ${PLUGIN_ROOT_DIR}/lib/validators/validateServiceRecordData.sh type ${SERVICE_PROTO};
                typeset -i RET_CODE=${?};
