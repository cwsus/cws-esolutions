...
function executeMonitoringScript
{
    ...
    cat /dev/null > ${PLUGIN_ROOT_DIR}/${TMP_DIRECTORY}/${MONITOR_OUTPUT_FILE};
        ...
        do
            ...
            then
                ...
                then
                    ...
                    $(${APP_ROOT}/${LIB_DIRECTORY}/tcl/runSSHConnection.exp ${MONITORED_HOST} "${REMOTE_APP_ROOT}/${LIB_DIRECTORY}/monitors/${MONITORING_SCRIPT}.sh" ${SSH_USER_NAME} ${SSH_USER_AUTH} ${MONITOR_THREAD_TIMEOUT});
                    typeset -i RET_CODE=${?};
                    ...
                    then
                        ...
                        IS_LOGFILE_PRESENT=$(${APP_ROOT}/${LIB_DIRECTORY}/tcl/runSSHConnection.exp ${MONITORED_HOST} "[ -s ${REMOTE_APP_ROOT}/${LOG_ROOT}/${BASE_LOG_NAME}-${MONITOR_RECORDER} ] && echo true || echo false" ${SSH_USER_NAME} ${SSH_USER_AUTH});
                        ...
                        then
                            ...
                            ## validate the input
                            ${APP_ROOT}/${LIB_DIRECTORY}/tcl/runSCPConnection.exp remote-copy ${MONITORED_HOST} ${REMOTE_APP_ROOT}/${LOG_ROOT}/${BASE_LOG_NAME}-${MONITOR_RECORDER} ${PLUGIN_ROOT_DIR}/${TMP_DIRECTORY}/${MONITORED_HOST}.${BASE_LOG_NAME}-${MONITOR_RECORDER} ${SSH_USER_NAME} ${SSH_USER_AUTH};
                            typeset -i RET_CODE=${?};
        ...
        do
            ...
            then
                ...
                then
                    ...
                    IS_LOGFILE_PRESENT=$(${APP_ROOT}/${LIB_DIRECTORY}/tcl/runSSHConnection.exp ${MONITORED_HOST} "[ -s ${REMOTE_APP_ROOT}/${LOG_ROOT}/${BASE_LOG_NAME}-${MONITOR_RECORDER} ] && echo true || echo false" ${IPLANET_OWNING_USER} ${SSH_USER_NAME} ${SSH_USER_AUTH});
