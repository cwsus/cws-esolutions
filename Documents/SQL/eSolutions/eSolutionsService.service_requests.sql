...
CREATE TABLE `esolutionssvc`.`service_requests` (
    ...
    `SERVICE_REQUEST_SUBMITDATE` DATE NOT NULL DEFAULT CURRENT_TIMESTAMP(),
    `SERVICE_REQUEST_STATUS` VARCHAR(32) CHARACTER SET UTF8 NOT NULL,
    `SERVICE_REQUEST_ASSIGNEE` VARCHAR(128) CHARACTER SET UTF8 NOT NULL,
    `SERVICE_REQUEST_COMMENTS` TEXT CHARACTER SET UTF8,
    `SERVICE_REQUEST_CLOSEDATE` DATE,
