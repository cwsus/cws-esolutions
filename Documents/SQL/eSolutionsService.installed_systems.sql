...
CREATE TABLE `esolutionssvc`.`installed_systems` (
    ...
    FULLTEXT KEY `IDX_SEARCH` (`SYSTEM_GUID`, `SYSTEM_OSTYPE`, `SYSTEM_STATUS`, `SYSTEM_REGION`, `SYSTEM_TYPE`, `OPER_HOSTNAME`, `ASSIGNED_ENGINEER`, `OWNING_DMGR`)
...
BEGIN
    SELECT
        ...
        OWNING_DMGR,
        MGR_ENTRY,
    MATCH (`SYSTEM_GUID`, `SYSTEM_OSTYPE`, `SYSTEM_STATUS`, `SYSTEM_REGION`, `SYSTEM_TYPE`, `OPER_HOSTNAME`, `ASSIGNED_ENGINEER`, `OWNING_DMGR`)
    AGAINST (+attributeName WITH QUERY EXPANSION)
    FROM `esolutionssvc`.`installed_systems`
    WHERE MATCH (`SYSTEM_GUID`, `SYSTEM_OSTYPE`, `SYSTEM_STATUS`, `SYSTEM_REGION`, `SYSTEM_TYPE`, `OPER_HOSTNAME`, `ASSIGNED_ENGINEER`, `OWNING_DMGR`)
...
BEGIN
    ...
    THEN
        ...
        (SYSTEM_GUID, SYSTEM_OSTYPE, SYSTEM_STATUS, SYSTEM_REGION, SYSTEM_TYPE, DOMAIN_NAME, CPU_TYPE, CPU_COUNT, SERVER_RACK, RACK_POSITION, SERVER_MODEL, SERIAL_NUMBER, INSTALLED_MEMORY, OPER_IP, OPER_HOSTNAME, MGMT_IP, MGMT_HOSTNAME, BKUP_IP, BKUP_HOSTNAME, NAS_IP, NAS_HOSTNAME, NAT_ADDR, COMMENTS, ASSIGNED_ENGINEER, ADD_DATE, MGR_ENTRY, OWNING_DMGR)
        VALUES
        (systemGuid, systemOs, systemStatus, systemRegion, systemType, domainName, cpuType, cpuCount, serverRack, rackPosition, serverModel, serialNumber, installedMemory, operIp, operHostname, mgmtIp, mgmtHostname, backupIp, backupHostname, nasIp, nasHostname, natAddr, systemComments, engineer, NOW(), mgrEntry, owningDmgr);
    ELSE
        INSERT INTO `esolutionssvc`.`installed_systems`
        (SYSTEM_GUID, SYSTEM_OSTYPE, SYSTEM_STATUS, SYSTEM_REGION, SYSTEM_TYPE, DOMAIN_NAME, CPU_TYPE, CPU_COUNT, SERVER_RACK, RACK_POSITION, SERVER_MODEL, SERIAL_NUMBER, INSTALLED_MEMORY, OPER_IP, OPER_HOSTNAME, MGMT_IP, MGMT_HOSTNAME, BKUP_IP, BKUP_HOSTNAME, NAS_IP, NAS_HOSTNAME, NAT_ADDR, COMMENTS, ASSIGNED_ENGINEER, ADD_DATE, MGR_ENTRY, DMGR_PORT, OWNING_DMGR)
        VALUES
        (systemGuid, systemOs, systemStatus, systemRegion, systemType, domainName, cpuType, cpuCount, serverRack, rackPosition, serverModel, serialNumber, installedMemory, operIp, operHostname, mgmtIp, mgmtHostname, backupIp, backupHostname, nasIp, nasHostname, natAddr, systemComments, engineer, NOW(), mgrEntry, dmgrPort, owningDmgr);
    END IF;
