...
BEGIN
    ...
    SET
        ...
        svc_message_author = messageAuthor,
        svc_message_email = authorEmail,
        svc_message_expires = expiryDate,
...
BEGIN
    SELECT
        ...
        svc_message_expires
    FROM `esolutionssvc`.`service_messages`
    WHERE svc_message_expires >= UNIX_TIMESTAMP()
    OR svc_message_expires IS NULL
