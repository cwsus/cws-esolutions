                ...
                then
                    ...
                    then
                        ...
                        then
                            ...
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Moving "${PLUGIN_WORK_DIRECTORY}/${DECOM_CONF_FILE}" to "${NAMED_ROOT}/${NAMED_CONF_DIR}/${DECOM_CONF_FILE}"..";
                            ...
                            then
                                ...
                                writeLogEntry "AUDIT" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Zone ${ZONE_NAME} removed by ${REQUESTING_USER} per change ${CHANGE_NUM} on $(date +"%m-%d-%Y") at $(date +"%H:%M:%S")";
    ...
    then
        ...
        then
            ...
            then
                ...
                then
                    ## it does. take a backup..
                    cp "${NAMED_ROOT}/${DECOM_CONF_FILE}" "${PLUGIN_BACKUP_DIR}/${DECOM_CONF_FILE}.${CHANGE_NUM}";
                    ...
                    then
                        ...
                        then
                            ...
                            then
                                ## we're done here.
                                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Removal of ${ZONE_NAME} from "${NAMED_ROOT}/${NAMED_CONF_DIR}"/$(tr "[A-Z]" "[a-z]" <<< ${BUSINESS_UNIT}).${NAMED_ZONE_CONF_NAME}) complete.";
                ...
                then
                    ...
                    then
                        ...
                        then
                                ...
                                then
                                    ...
                                    then
                                        ...
                                        then
                                            ...
                                            writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "An error occurred while removing ${ZONE_ENTRY} from ${ZONEFILE_NAME}.${DATACENTER}. Please perform manually.";
                            ...
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Moving file "${NAMED_ROOT}/${PLUGIN_WORK_DIRECTORY}"/${ZONEFILE_NAME} ..";
                            ...
                            then
                                ...
                                for DATACENTER in ${PRIMARY_DC} ${SECONDARY_DC}
                                do
                                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Moving file "${NAMED_ROOT}/${PLUGIN_WORK_DIRECTORY}"/${ZONEFILE_NAME}.${DATACENTER} ..";
                                    ...
                                    then
                                        ...
                                        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "An error occurred while moving ${ZONEFILE_NAME} to ${DATACENTER}. Please perform manually.";
                                ...
                                then
                                    ...
                                    do
                                        ...
                                        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Executing command "${NAMED_ROOT}"/${PLUGIN_LIB_DIRECTORY}/executors/executeRNDCCommands.sh -s ${NAMED_MASTER} -p ${RNDC_LOCAL_PORT} -y ${RNDC_LOCAL_KEY} -c reload -z "${ZONE_NAME}" -i ${HORIZON} -e";
                                    ...
                                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Executing command "${NAMED_ROOT}"/${PLUGIN_LIB_DIRECTORY}/executors/executeRNDCCommands.sh -s ${NAMED_MASTER} -p ${RNDC_LOCAL_PORT} -y ${RNDC_LOCAL_KEY} -c reload -z "${ZONE_NAME}" -e";
                                    ...
                                    then
                                        ...
                                        do
                                            ...
                                            then
                                                ...
                                                do
                                                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "HORIZON -> ${HORIZON}";
                                                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Executing command "${NAMED_ROOT}"/${PLUGIN_LIB_DIRECTORY}/executors/executeRNDCCommands.sh -s ${SLAVE} -p ${RNDC_REMOTE_PORT} -y ${RNDC_REMOTE_KEY} -c reload -z "${ZONE_NAME}" -i ${HORIZON} -e";
                                                ...
                                                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Executing command "${NAMED_ROOT}"/${PLUGIN_LIB_DIRECTORY}/executors/executeRNDCCommands.sh -s ${SLAVE} -p ${RNDC_REMOTE_PORT} -y ${RNDC_REMOTE_KEY} -c reload -z "${ZONE_NAME}" -e";
...
[ ! -z "${ENABLE_TRACE}" ] && [ "${ENABLE_TRACE}" = "${_TRUE}" ] && set -v;
    ...
    echo "Usage: ${THIS_CNAME} [ -b <business unit> ] [ -p <project code> ] [ -z <zone name> ] [ -i <requesting user> ] [ -c <change request> ] [ -r <entry> ] [ -x ] [ -s ] [ -e ] [ -h|-? ]
