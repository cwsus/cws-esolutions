            ...
            then
                ...
                case ${OP_PRI_CKSUM} in
                    *)
                        ...
                        then
                            ##
                            "${LOGGER}" "${LOGGER}" "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "WARNING: Primary datacenter zonefile checksum mis-match.";
                        ...
                        case ${OP_SEC_CKSUM} in
                            *)
                                ...
                                then
                                    ##
                                    "${LOGGER}" "${LOGGER}" "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "WARNING: Secondary datacenter zonefile checksum mis-match.";
