...
[ ! -z "${ENABLE_TRACE}" ] && [ "${ENABLE_TRACE}" = "${_TRUE}" ] && set -v;
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Generating RNDC keyfiles..";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Executing command rndc-confgen -b ${RNDC_KEY_BITSIZE} -r ${RANDOM_GENERATOR} > "${NAMED_ROOT}/${PLUGIN_WORK_DIRECTORY}"..";
    ...
    then
        ...
        then
            ...
            then
                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${RNDC_LOCAL_KEY} generation complete. Now generating ${RNDC_REMOTE_KEY}..";
                ...
                then
                    ...
                    then
                        ...
                        ## tar+gzip
                        tar cf "${PLUGIN_BACKUP_DIR}"/${BACKUP_FILE}.tar -C "${NAMED_ROOT}"/etc/dnssec-keys $(cut -d "/" -f 3 <<< ${RNDC_KEY_FILE}) \
                        ...
                        then
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Backup successful. Copying files..";
                            ...
                            for OPERATIONAL_FILE in "${PLUGIN_WORK_DIRECTORY}"/$(cut -d "/" -f 3 <<< ${RNDC_KEY_FILE}) \
                                "${PLUGIN_WORK_DIRECTORY}"/$(cut -d "/" -f 3 <<< ${RNDC_CONF_FILE})
                            do
                                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Validating ${OPERATIONAL_FILE}..";
                                ...
                                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "MOD_FILE_CKSUM -> ${MOD_FILE_CKSUM}";

                                if [ ${OP_FILE_CKSUM} -eq ${MOD_FILE_CKSUM} ]
                                then
                                    ## matched. continue
                                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Checksum match. Continuing..";

                                    continue;
                                else
                                    ## cksum mismatch, fail
                                    writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "CHECKSUM MISMATCH: ${OPERATIONAL_FILE} - ${OP_FILE_CKSUM} / "${NAMED_ROOT}"/etc/dnssec-keys/$(cut -d "/" -f 4 <<< ${OPERATIONAL_FILE}) - ${MOD_FILE_CKSUM})";
                            ...
                            writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to generate backup file. Cannot continue.";

                            RETURN_CODE=57;
                        fi
                    else
                        ## key generation succeeded, but file write failed
                        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to write out key configuration. Cannot continue.";

                        RETURN_CODE=94;
                    fi
                else
                    ## key generation failed
                    writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed generate new keys. Cannot continue.";

                    RETURN_CODE=94;
                fi
            else
                ## key generation succeeded, but we failed to write the file
                writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to write temporary configuration files. Cannot continue.";

                RETURN_CODE=47;
            fi
        else
            ## no valid keytype
            writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "No valid keytype was provided for generation.";
...
[ ! -z "${ENABLE_TRACE}" ] && [ "${ENABLE_TRACE}" = "${_TRUE}" ] && set -v;
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "KEY_DIRECTORY->${KEY_DIRECTORY}";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "ZSK_KEY_DST_FILE_NAME->${ZSK_KEY_DST_FILE_NAME}";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "ZSK_PRV_DST_FILE_NAME->${ZSK_PRV_DST_FILE_NAME}";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "KSK_KEY_DST_FILE_NAME->${KSK_KEY_DST_FILE_NAME}";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "KSK_PRV_DST_FILE_NAME->${KSK_PRV_DST_FILE_NAME}";
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Setting backup file to "${NAMED_ROOT}/${BACKUP_DIRECTORY}"/${FILENAME}.\`date +"%m-%d-%Y"\`.${CHANGE_NUM}.${REQUESTING_USER}";
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copying ${FILENAME} to "${NAMED_ROOT}/${PLUGIN_WORK_DIRECTORY}"..";
    ...
    then
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to create copy file. Cannot continue.";
    ...
    ## if not make it
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Validating business unit key signing directory..";
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Key generation complete. GENERATED_ZSK_FILE -> ${GENERATED_ZSK_FILE}";
    ...
    then
        ...
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "ZSK key generation FAILURE. Cleanup...";
    ...
    ## want them to be
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Key generation verified. Renaming..";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copying ${KEY_DIRECTORY}/${GENERATED_ZSK_FILE}.key to ${KEY_DIRECTORY}/${ZSK_KEY_DST_FILE_NAME}..";

    cp ${KEY_DIRECTORY}/${GENERATED_ZSK_FILE}.key ${KEY_DIRECTORY}/${ZSK_KEY_DST_FILE_NAME};

    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copying ${KEY_DIRECTORY}/${GENERATED_ZSK_FILE}.private to ${KEY_DIRECTORY}/${ZSK_PRV_DST_FILE_NAME}..";

    cp ${KEY_DIRECTORY}/${GENERATED_ZSK_FILE}.private ${KEY_DIRECTORY}/${ZSK_PRV_DST_FILE_NAME};

    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copies complete. Validating..";

    if [ ! -s ${KEY_DIRECTORY}/${ZSK_PRV_DST_FILE_NAME} ] && [ ! -s ${KEY_DIRECTORY}/${ZSK_KEY_DST_FILE_NAME} ]
    then
        ## ksk generation failed. error out
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to generate ZSK keys. Cannot continue.";
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copy validated. Removing source files..";

    rm -rf ${KEY_DIRECTORY}/${GENERATED_ZSK_FILE}.key;
    rm -rf ${KEY_DIRECTORY}/${GENERATED_ZSK_FILE}.private;

    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Removal complete. Generating KSK keys..";
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Key generation complete. GENERATED_KSK_FILE -> ${GENERATED_KSK_FILE}";
    ...
    then
        ## ksk generation failed. error out
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to generate KSK keys. Cannot continue.";
    ...
    ## want them to be
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Key generation verified. Renaming..";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copying ${KEY_DIRECTORY}/${GENERATED_KSK_FILE}.key to ${KEY_DIRECTORY}/${KSK_KEY_DST_FILE_NAME}..";

    cp ${KEY_DIRECTORY}/${GENERATED_KSK_FILE}.key ${KEY_DIRECTORY}/${KSK_KEY_DST_FILE_NAME};

    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copying ${KEY_DIRECTORY}/${GENERATED_KSK_FILE}.private to ${KEY_DIRECTORY}/${KSK_PRV_DST_FILE_NAME}..";
    ...
    then
        ...
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to properly rename keys. Cannot continue.";
    ...
    ## finalize.
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Key generation complete. Updating zonefile..";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Stripping header...";
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Printing \$INCLUDE ${KEY_DIRECTORY}/${ZSK_KEY_DST_FILE_NAME} ..";
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Printing \$INCLUDE ${KEY_DIRECTORY}/${KSK_KEY_DST_FILE_NAME} ..";
    ...
    then
        ...
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to add keyfile includes in zone. Cannot continue.";
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Keyfile inclusion complete. Signing zone..";
    ...
    then
        ## failed to sign the zone with the keys
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "dnssec-signzone has FAILED. Please inspect logs for cause/resolution.";
    ...
    then
        ## file rename failed
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to rename signed zone to ${FILENAME}. Cannot continue.";
    ...
    then
        ## shift failed
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Successfully renamed signed zone to ${FILENAME}, but content could not be verified. Cannot continue.";
    ...
    then
        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Adding header..";
        ...
        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Adding signed content..";
        ...
        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Signed zone now available. Creating datacenter-specifics...";
        ...
        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "CURRENT_DC->${CURRENT_DC}";

        ## set the IP flag
        [ "${CURRENT_DC}" = "${PRIMARY_DC}" ] && CURRENT_IP=${PRIMARY_DATACENTER_IP} || CURRENT_IP=${SECONDARY_DATACENTER_IP};

        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "CURRENT_IP->${CURRENT_IP}";

        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Creating datacenter specific files..";
        ...
        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Headers added. Adding signed content..";

        ## we have headers, add in the signature
        if [ "${CURRENT_DC}" = "${PRIMARY_DC}" ]
        then
            ## add in the signed content, leaving everything unchanged
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Adding signatures for ${PRIMARY_DC}..";

            cat "${NAMED_ROOT}/${PLUGIN_WORK_DIRECTORY}"/${FILENAME} >> "${NAMED_ROOT}/${PLUGIN_WORK_DIRECTORY}"/${FILENAME}.${PRIMARY_DC};

            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Adding signatures for ${SECONDARY_DC} and flipping IP to ${SECONDARY_DATACENTER_IP}..";
        ...
        then
            ## add in the signed content, leaving everything unchanged
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Adding signatures for ${SECONDARY_DC}..";

            cat "${NAMED_ROOT}/${PLUGIN_WORK_DIRECTORY}"/${FILENAME} >> "${NAMED_ROOT}/${PLUGIN_WORK_DIRECTORY}"/${FILENAME}.${SECONDARY_DC};

            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Adding signatures for ${PRIMARY_DC} and flipping IP to ${PRIMARY_DATACENTER_IP}..";
            ...
            ## error out
            writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Unknown datacenter ${CURRENT_DC}. Cannot continue.";
        ...
        then
            ...
            ## pull checksums
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Placing files..";
            ...
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "SIGNED_TMP_CKSUM -> ${SIGNED_TMP_CKSUM}";
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "SIGNED_PRI_CKSUM -> ${SIGNED_PRI_CKSUM}";
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "SIGNED_SEC_CKSUM -> ${SIGNED_SEC_CKSUM}";
            ...
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "OP_TMP_CKSUM -> ${OP_TMP_CKSUM}";

            if [ ${SIGNED_TMP_CKSUM} -eq ${OP_TMP_CKSUM} ]
            then
                ## checksum match. continue.
                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Operational zonefile checksum match. Continuing..";
                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copying primary datacenter files..";
                ...
                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "OP_PRI_CKSUM -> ${OP_PRI_CKSUM}";
                ...
                case ${OP_PRI_CKSUM} in
                    *)
                        ...
                        then
                            ##
                            writeLogEntry writeLogEntry "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "WARNING: Primary datacenter zonefile checksum mis-match.";

                            RETURN_WARNING=${_TRUE};
                        else
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Primary datacenter zonefile checksum match. Continuing..";
                        fi

                        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Copying secondary datacenter files..";
                        ...
                        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "OP_SEC_CKSUM -> ${OP_SEC_CKSUM}";
                        ...
                        case ${OP_SEC_CKSUM} in
                            *)
                                ...
                                then
                                    ##
                                    writeLogEntry writeLogEntry "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "WARNING: Secondary datacenter zonefile checksum mis-match.";

                                    RETURN_WARNING=${_TRUE};
                                else
                                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Secondary datacenter zonefile checksum match. Continuing..";
                                fi
                ...
                writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to copy signed operational zonefile. Cannot continue.";
        ...
        ## dsset shift failed
        writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to rename dsset-${ZONE_NAME}. to dsset-${ZONE_NAME}.${PROJECT_CODE}. Cannot continue.";
...
[ ! -z "${ENABLE_TRACE}" ] && [ "${ENABLE_TRACE}" = "${_TRUE}" ] && set -v;
    ...
    then
        ...
        do
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "DNS_SLAVE_IPS -> ${DNS_SLAVE_IPS[${A}]}";
        ...
        then
            ...
            then
                ...
                ## tar+gzip
                tar cf "${PLUGIN_BACKUP_DIR}"/${BACKUP_FILE}.tar -C "${NAMED_ROOT}"/etc/dnssec-keys $(cut -d "/" -f 3 <<< ${TRANSFER_KEY_FILE}) > /dev/null 2>&1;
                gzip "${PLUGIN_BACKUP_DIR}"/${BACKUP_FILE}.tar > /dev/null 2>&1;
                ...
                then
                    ...
                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Validating checksums..";
...
[ ! -z "${ENABLE_TRACE}" ] && [ "${ENABLE_TRACE}" = "${_TRUE}" ] && set -v;
    ...
    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Generating DHCP keyfiles..";
    ...
    then
        ...
        then
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${DHCPD_UPDATE_KEY} generation complete.";
            ...
            then
                ...
                ## tar+gzip
                tar cf "${PLUGIN_BACKUP_DIR}"/${BACKUP_FILE}.tar -C "${NAMED_ROOT}"/etc/dnssec-keys $(cut -d "/" -f 3 <<< ${DHCPD_KEY_FILE}) > /dev/null 2>&1;
                gzip "${PLUGIN_BACKUP_DIR}"/${BACKUP_FILE}.tar > /dev/null 2>&1;
...
do
    case "${OPTIONS}" in
        r)
            ...
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Setting generateRNDCKeys..";
        ...
        k)
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "OPTARG -> ${OPTARG}";
            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Setting generateDNSSECKeys..";
        ...
        e)
            ...
            if [ -z "${KEYTYPE}" ]
            then
                writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "No key type was provided. Unable to continue processing.";
            ...
            then
                writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "No auditable user account was provided. Unable to continue processing.";
