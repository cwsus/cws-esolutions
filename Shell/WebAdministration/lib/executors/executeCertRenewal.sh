                                                ...
                                                then
                                                    ...
                                                    then
                                                        ...
                                                        then
                                                            ...
                                                            ## "${LOGGER}" "AUDIT" "${METHOD_NAME}".
                                                            "${LOGGER}" "${LOGGER}" "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "No keys/certificates were found in the crypto card to clean. Cannot continue.";
                                                            ...
                                                            then
                                                                ...
                                                                ## but it should be corrected anyway. "${LOGGER}" "AUDIT" "${METHOD_NAME}"
                                                                "${LOGGER}" "${LOGGER}" "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Crypto card cleanup action has FAILED. Please execute manually.";
                                                        ...
                                                        ## "${LOGGER}" "AUDIT" "${METHOD_NAME}" - this is not fatal
                                                        "${LOGGER}" "${LOGGER}" "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "No keys/certificates were found in the provided keystore for action.";
