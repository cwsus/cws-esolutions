                    ...
                    then
                        ...
                        then
                            ...
                            then
                                ...
                                writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Data mismatch detected. Throwing error.";
                                [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${METHOD_NAME} -> exit";
                                ...
                                then
                                    ...
                                    do
                                        ...
                                        ## add the entry...
                                        echo "zone \"${ZONE_LISTING[${D}]}\" IN {" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                        echo "    type              master;" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                        echo "    file              \"${FILE_LISTING[${D}]}\";" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                        echo "    allow-update      { none; };" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                        echo "    allow-transfer    { key ${TSIG_TRANSFER_KEY}; };" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                    ...
                                    then
                                        ...
                                        then
                                            ...
                                            writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to properly copy the decom configuration file. Unable to continue.";
                                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${METHOD_NAME} -> exit";
                                                        ...
                                                        then
                                                            ...
                                                            then
                                                                ...
                                                                then
                                                                    ...
                                                                    echo "include \"/"${NAMED_CONF_DIR}/${DECOM_CONF_FILE}"\";" >> "${APP_ROOT}/${TMP_DIRECTORY}"/$(echo ${NAMED_CONF_FILE} | cut -d "/" -f 5).${CHANGE_NUM};
                                                                fi
                                                                ...
                                                                then
                                                                    ...
                                                                    then
                                                                        ...
                                                                        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Decommission of ${ZONE_NAME} from "${NAMED_ROOT}/${NAMED_CONF_DIR}"/$(echo ${BUSINESS_UNIT} | tr "[A-Z]" "[a-z]").${NAMED_ZONE_CONF_NAME} complete.";
                                                                        writeLogEntry "AUDIT" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Zone ${ZONE_NAME} decommissioned by ${IUSER_AUDIT} per change ${CHANGE_NUM} on $(date +"%m-%d-%Y") at $(date +"%H:%M:%S")";
                    ...
                    then
                        ...
                        then
                            ...
                            then
                                ...
                                echo "zone \"${ZONE_NAME}\" IN {" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "    type              master;" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "    file              \"${NAMED_MASTER_ROOT}/${GROUP_ID}${NAMED_DECOM_DIR}/${GROUP_ID}${BUSINESS_UNIT}/${ZONEFILE_NAME}\";" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "    allow-update      { none; };" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "    allow-transfer    { key ${TSIG_TRANSFER_KEY}; };" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "};\n" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                            ...
                                            then
                                                ...
                                                then
                                                    ...
                                                    then
                                                        ...
                                                        [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Moving "${APP_ROOT}/${TMP_DIRECTORY}"/$(echo ${BUSINESS_UNIT} | tr "[A-Z]" "[a-z]").${NAMED_ZONE_CONF_NAME} to "${NAMED_ROOT}/${NAMED_CONF_DIR}"/$(echo ${BUSINESS_UNIT} | tr "[A-Z]" "[a-z]").${NAMED_ZONE_CONF_NAME}..";
                        ...
                        then
                            ...
                            then
                                ...
                                then
                                    ...
                                    [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Confirmation complete. Removing entry from "${NAMED_ROOT}/${NAMED_CONF_DIR}"/$(echo ${BUSINESS_UNIT} | tr "[A-Z]" "[a-z]").${NAMED_ZONE_CONF_NAME})..";
                    ...
                    then
                        ...
                        then
                            ...
                            then
                                ...
                                ## first, add it to the decom conf file
                                echo "zone \"${ZONE_NAME}\" IN {" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "    type              slave;" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "    masters           { \"${NAMED_MASTER_ACL}\"; };" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "    file              \"${NAMED_SLAVE_ROOT}/${GROUP_ID}${NAMED_DECOM_DIR}/${GROUP_ID}${BUSINESS_UNIT}/${ZONEFILE_NAME}\";" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "    allow-transfer    { key ${TSIG_TRANSFER_KEY}; };" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                echo "};\n" >> "${APP_ROOT}/${TMP_DIRECTORY}/${DECOM_CONF_FILE}";
                                    ...
                                    then
                                        ...
                                        then
                                            ...
                                            then
                                                ...
                                                ## couldnt create the backup file
                                                writeLogEntry "ERROR" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to create configuration backup. Cannot continue.";
                                                [ ${VERBOSE} ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${METHOD_NAME} -> exit";
            ...
            then
                ...
                then
                    ...
                    then
                        ...
                        then
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Request validated - executing single site slave decommission";
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${METHOD_NAME} -> exit";

                            decom_slave_zone;
                        else
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Request validated - executing single site master decommission";
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${METHOD_NAME} -> exit";
                        ...
                        if [ ! -z "${SLAVE_OPERATION}" ] && [ "${SLAVE_OPERATION}" = "${_TRUE}" ]
                        then
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Request validated - executing business unit decommission";
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${METHOD_NAME} -> exit";

                            decom_slave_bu;
                        else
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Request validated - executing business unit master decommission";
                            [ ! -z "${ENABLE_DEBUG}" ] && [ "${ENABLE_DEBUG}" = "${_TRUE}" ] && writeLogEntry "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "${METHOD_NAME} -> exit";
