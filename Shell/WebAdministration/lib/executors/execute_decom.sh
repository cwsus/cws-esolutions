                                        ...
                                        then
                                            ...
                                            then
                                                ...
                                                then
                                                            ...
                                                            then
                                                                ...
                                                                then
                                                                    ...
                                                                    then
                                                                        ...
                                                                        ## copy to where its supposed to go. this *should* be ok, but does warrant some review. "${LOGGER}" "AUDIT" "${METHOD_NAME}".
                                                                        "${LOGGER}" "${LOGGER}" "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "CHECKSUM MISMATCH: Failed to validate that named configuration file was updated.";
                                                    ...
                                                    ## failed to remove bu conf file. "${LOGGER}" "AUDIT" "${METHOD_NAME}", but dont fail.
                                                ...
                                                then
                                                    ...
                                                    then
                                                        ...
                                                        then
                                                            ...
                                                            ## process, as named will continue chugging along with an empty file. "${LOGGER}" "AUDIT" "${METHOD_NAME}".
                                                            "${LOGGER}" "${LOGGER}" "AUDIT" "${METHOD_NAME}" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Failed to remove zone include statement from named configuration file.";
