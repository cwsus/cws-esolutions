...
function monitorCertExpiry
{
    ...
    [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "VERIFIABLE_TIME -> ${VERIFIABLE_TIME}";
    ...
    do
        ...
        [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Executing command runSSHConnection.exp ${WEBSERVER} \"${REMOTE_APP_ROOT}/lib/monitors/monitorCertificates.sh listSites\" ${IPLANET_OWNING_USER}";
        ...
        VERIFIABLE_SITES=$(${APP_ROOT}/lib/tcl/runSSHConnection.exp ${WEBSERVER} "${REMOTE_APP_ROOT}/lib/monitors/monitorCertificates.sh listSites" ${IPLANET_OWNING_USER});

        [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "SERVER_ROOT -> ${SERVER_ROOT}";
        [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "SERVER_REGION -> ${SERVER_REGION}";
        [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "SERVER_PARTITION -> ${SERVER_PARTITION}";
        [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "VERIFIABLE_SITES -> ${VERIFIABLE_SITES}";
                ...
                then
                    ...
                    do
                        ...
                        then
                            ...
                            [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "Executing command OpenSSL...";
                            ...
                            RETURNED_EXPIRY=$(${APP_ROOT}/lib/tcl/runSSHConnection.exp ${PROXY} "echo \"quit\n\" | \
                            ...
                            [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "RETURNED_EXPIRY -> ${RETURNED_EXPIRY}";
                            ...
                            then
                                ...
                                then
                                    ...
                                    [[ ! -z "${VERBOSE}" && "${VERBOSE}" = "${_TRUE}" ]] && ${LOGGER} "DEBUG" "${METHOD_NAME}" "${CNAME}" "${LINENO}" "EXPIRY_MONTH -> ${EXPIRY_MONTH}";
