...
function usage
{
    ...
    echo "${THIS_CNAME} - Add "AUDIT" indicators and other flags to the failover zone file";
    echo "Usage: ${THIS_CNAME} [-r ZONE_ROOT] [-f filename] [-t target datacenter] [-i requestor] [-c change request] [-e execute] [-?|-h show this help]";
