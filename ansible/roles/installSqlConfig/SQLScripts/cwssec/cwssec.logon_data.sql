...
CREATE TABLE CWSSEC.LOGON_DATA (
    ...
    SALT VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL UNIQUE,
    SALT_TYPE ENUM ('LOGON', 'RESET', 'AUTHTOKEN') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
