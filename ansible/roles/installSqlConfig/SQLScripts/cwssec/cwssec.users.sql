...
CREATE TABLE CWSSEC.USERS (
    ...
    CWSROLE VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '3517632B-E77F-49FF-BD99-A42EA8335DCC',
    CWSFAILEDPWDCOUNT MEDIUMINT DEFAULT '0',
    ...
    SN VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Surname',
    GIVENNAME VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Given Name',
    DISPLAYNAME VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Display Name',
    CWSEXPIRYDATE TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
    CWSSECQ1 VARCHAR(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Question 1',
    CWSSECQ2 VARCHAR(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Question 2',
    CWSSECANS1 VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Answer 1',
    CWSSECANS2 VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Answer 2',
...
CREATE PROCEDURE CWSSEC.addUserAccount(
    ...
    IN userPass VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN userRole VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN surname VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN givenName VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN saltValue VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN saltType VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN emailAddr VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN telNumber VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN pagerNumber VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
)
BEGIN
...
CREATE PROCEDURE CWSSEC.modifyUserPassword(
    IN commonName VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN newPassword VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
)
BEGIN
    UPDATE CWSSEC.USERS
    SET
...
CREATE PROCEDURE CWSSEC.addOrUpdateSecurityQuestions(
    IN commonName VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN secQuestionOne VARCHAR(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN secQuestionTwo VARCHAR(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN secAnswerOne VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
    IN secAnswerTwo VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
)
BEGIN
    UPDATE CWSSEC.USERS
    SET
