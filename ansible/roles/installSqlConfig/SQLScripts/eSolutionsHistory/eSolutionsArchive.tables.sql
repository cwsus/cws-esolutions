...
DROP TABLE IF EXISTS `eSolutionsArchive`.`articles` //
DROP TABLE IF EXISTS `eSolutionsArchive`.`installed_applications` //
DROP TABLE IF EXISTS `eSolutionsArchive`.`installed_systems` //
DROP TABLE IF EXISTS `eSolutionsArchive`.`service_datacenters` //
DROP TABLE IF EXISTS `eSolutionsArchive`.`service_messages` //
DROP TABLE IF EXISTS `eSolutionsArchive`.`service_platforms` //
DROP TABLE IF EXISTS `eSolutionsArchive`.`dns_service` //

CREATE TABLE `eSolutionsArchive`.`articles` (
...
CREATE TABLE `eSolutionsArchive`.`dns_service` (
...
CREATE TABLE `eSolutionsArchive`.`installed_applications` (
...
CREATE TABLE `eSolutionsArchive`.`installed_systems` (
    ...
    CONSTRAINT `FK_DATACENTER_GUID`
        ...
        REFERENCES `eSolutionsArchive`.`service_datacenters` (`DATACENTER_GUID`)
            ON DELETE RESTRICT
            ON UPDATE NO ACTION,
...
CREATE TABLE `eSolutionsArchive`.`service_datacenters` (
    `GUID` VARCHAR(128) CHARACTER SET UTF8 NOT NULL,
...
CREATE TABLE `eSolutionsArchive`.`service_messages` (
...
CREATE TABLE `eSolutionsArchive`.`service_platforms` (
    `GUID` VARCHAR(128) CHARACTER SET UTF8 NOT NULL UNIQUE,
...
ALTER TABLE `eSolutionsArchive`.`articles` CONVERT TO CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI //
ALTER TABLE `eSolutionsArchive`.`dns_service` CONVERT TO CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI //
ALTER TABLE `eSolutionsArchive`.`installed_applications` CONVERT TO CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI //
ALTER TABLE `eSolutionsArchive`.`installed_systems` CONVERT TO CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI //
ALTER TABLE `eSolutionsArchive`.`service_datacenters` CONVERT TO CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI //
ALTER TABLE `eSolutionsArchive`.`service_messages` CONVERT TO CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI //
ALTER TABLE `eSolutionsArchive`.`service_platforms` CONVERT TO CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI //
