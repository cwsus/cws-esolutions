...
public class SystemCheckActivity extends Activity
{
    ...
    {
        final String methodName = SystemCheckActivity.CNAME + "#onCreate(final Bundle bundle)";
    ...
    {
        final String methodName = SystemCheckActivity.CNAME + "#onCreateOptionsMenu(final Menu menu)";
    ...
    {
        final String methodName = SystemCheckActivity.CNAME + "#onOptionsItemSelected(final MenuItem item)";
