...
public class SystemManagementActivity extends Activity
{
            ...
            if (userAccount != null)
            {
                switch (userAccount.getStatus())
                {
                    ...
                    default:
                        ...
                        super.startActivity(new Intent(SystemManagementActivity.this, LoginActivity.class));
                        super.finish();
    ...
    {
        final String methodName = SystemManagementActivity.CNAME + "#onBackPressed()";
    ...
    public boolean onOptionsItemSelected(final MenuItem item)
    {
        ...
        switch (item.getItemId())
        {
            case R.id.applicationManagement:
                intent = new Intent(SystemManagementActivity.this, ApplicationManagementActivity.class);
            ...
            case R.id.dnsService:
                intent = new Intent(SystemManagementActivity.this, DNSServiceActivity.class);
                intent.putExtra(Constants.USER_DATA, userAccount);
                ...
                return true;
            case R.id.home:
                intent = new Intent(SystemManagementActivity.this, HomeActivity.class);
                intent.putExtra(Constants.USER_DATA, userAccount);
            ...
            case R.id.serviceManagement:
                intent = new Intent(SystemManagementActivity.this, ServiceManagementActivity.class);
                intent.putExtra(Constants.USER_DATA, userAccount);
            ...
            case R.id.serviceMessaging:
                intent = new Intent(SystemManagementActivity.this, ServiceMessagingActivity.class);
                intent.putExtra(Constants.USER_DATA, userAccount);
            ...
            case R.id.userAccount:
                intent = new Intent(SystemManagementActivity.this, UserAccountActivity.class);
                intent.putExtra(Constants.USER_DATA, userAccount);
            ...
            case R.id.userManagement:
                intent = new Intent(SystemManagementActivity.this, UserManagementActivity.class);
                intent.putExtra(Constants.USER_DATA, userAccount);
            ...
            case R.id.virtualManager:
                intent = new Intent(SystemManagementActivity.this, VirtualManagerActivity.class);
                intent.putExtra(Constants.USER_DATA, userAccount);
            ...
            case R.id.signout:
                ...
                intent = new Intent(SystemManagementActivity.this, LoginActivity.class);
