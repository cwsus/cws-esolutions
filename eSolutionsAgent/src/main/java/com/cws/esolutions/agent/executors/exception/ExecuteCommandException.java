...
{
    private static final long serialVersionUID = -6318911034868738885L;

    public ExecuteCommandException(final String message)
    {
        super(message);
    }

    public ExecuteCommandException(final Throwable throwable)
    {
        super(throwable);
    }

    public ExecuteCommandException(final String message, final Throwable throwable)
    {
