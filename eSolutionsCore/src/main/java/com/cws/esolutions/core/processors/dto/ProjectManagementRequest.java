 ...
 * Package: com.cws.esolutions.core.processors.dto
 * File: ProjectManagementRequest.java
 *
 * History
 *
...
public class ProjectManagementRequest implements Serializable
{
    ...
    private static final long serialVersionUID = 7600107298844134150L;
    private static final String CNAME = ProjectManagementRequest.class.getName();
    ...
    {
        final String methodName = ProjectManagementRequest.CNAME + "#setUserAccount(final UserAccount value)";
    ...
    {
        final String methodName = ProjectManagementRequest.CNAME + "#setRequestInfo(final RequestHostInfo value)";
    ...
    {
        final String methodName = ProjectManagementRequest.CNAME + "#setServiceId(final String value)";
    ...
    {
        final String methodName = ProjectManagementRequest.CNAME + "#getUserAccount()";
    ...
    {
        final String methodName = ProjectManagementRequest.CNAME + "#getRequestInfo()";
    ...
    {
        final String methodName = ProjectManagementRequest.CNAME + "#getServiceId()";
    ...
    {
        final String methodName = ProjectManagementRequest.CNAME + "#getProject()";
    ...
    {
        final String methodName = ProjectManagementRequest.CNAME + "#toString()";
