...
public final class EmailUtils
{
     ...
     */
    public static final synchronized void sendEmailMessage(final EmailMessage message) throws MessagingException
    {
        final String methodName = EmailUtils.CNAME + "#sendEmailMessage(final EmailMessage message) throws MessagingException";
        ...
        try
        {
            MimeMessage mailMessage = EmailUtils.mailSender.createMimeMessage();
            ...
            if (message.getMessageTo().size() != 0)
            {
                ...
                mailMessage.setSubject("[" + RandomStringUtils.randomAlphanumeric(16) + "] " + message.getMessageSubject());
     ...
     * @throws MessagingException
     */
    public static final synchronized void sendEmailMessage(final SimpleMailMessage message) throws MessagingException
    {
        final String methodName = EmailUtils.CNAME + "#sendEmailMessage(final SimpleMailMessage message) throws MessagingException";
        ...
        try
        {
            EmailUtils.mailSender.send(message);
        }
