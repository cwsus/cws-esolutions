...
public class LDAPAuthenticator implements Authenticator
{
    ...
    {
        final String methodName = LDAPAuthenticator.CNAME + "#changeUserPassword(final String userGuid, final String newPass, final Long expiry) throws AuthenticatorException";
    ...
    @Override
    public synchronized boolean createSecurityData(final String userId, final String userGuid, final List<String> data) throws AuthenticatorException
    {
        final String methodName = LDAPAuthenticator.CNAME + "#obtainSecurityData(final String userId, final String userGuid, final List<String> data) throws AuthenticatorException";
                ...
                if (ldapConn.isConnected())
                {
                    ...
                    if ((searchResult.getResultCode() == ResultCode.SUCCESS) && (searchResult.getSearchEntries().size() == 1))
                    {
                        ...
                        (
                            Arrays.asList
                            (
                                new Modification(ModificationType.ADD, authData.getSecQuestionOne(), data.get(0)),
                                new Modification(ModificationType.ADD, authData.getSecQuestionTwo(), data.get(1)),
                                new Modification(ModificationType.ADD, authData.getSecAnswerOne(), data.get(2)),
