 ...
 * AdminControlServiceImplTest.java
 *
 * $Id: $
 * $Author: $
 * $Date: $
 ...
 * History
 * ----------------------------------------------------------------------------
 * 35033355 @ Jun 11, 2013 12:43:42 PM
 *     Created.
 */
public class AdminControlServiceImplTest
{
    ...
    @Test
    public final void testAdminControlServiceUserAccount()
    {
        try
        {
            Assert.assertTrue(service.adminControlService(userAccount));
        }
    ...
    @Test
    public final void testAdminControlServiceServiceAdmin()
    {
        try
        {
            Assert.assertTrue(service.adminControlService(userAccount, AdminControlType.SERVICE_ADMIN));
        }
        catch (AdminControlServiceException acsx)
        {
            Assert.fail(acsx.getMessage());
    ...
    @Test
    public final void testAdminControlServiceUserAdmin()
    {
        try
        {
            Assert.assertTrue(service.adminControlService(userAccount, AdminControlType.USER_ADMIN));
        }
        catch (AdminControlServiceException acsx)
        {
            Assert.fail(acsx.getMessage());
