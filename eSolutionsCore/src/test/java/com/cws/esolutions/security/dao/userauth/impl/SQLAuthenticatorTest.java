...
public class SQLAuthenticatorTest
{
    ...
    public void testPasswordLogon()
    {
        try
        {
            Assert.assertNotNull(authenticator.performLogon("74d9729b-7fb2-4fef-874b-c9ee5d7a5a95", "khuntly", "4MEK2S5r0fjVfk1wP2mrytpXcaI9m1hNr/zIq8RVdDgvR0VqbBmR1IHhonw124Au"));
        }
