            ...
            <ul id="latestnews">
                <li>
                    <form:form id="submitPasswordChange" name="submitPasswordChange" action="${pageContext.request.contextPath}/ui/online-reset/forgot-password/change-password" method="post" autocomplete="off">
                        ...
                        <input type="button" name="cancel" value="<spring:message code='theme.button.cancel.text' />" id="cancel" class="submit" onclick="redirectOnCancel('/esolutions/ui/auth/default');" />
                    </form:form>
                </li>
            </ul>
        </div>
