    ...
    <div class="wrapper">
        ...
        <p>
            <form:form id="createNewServer" name="createNewServer" action="${pageContext.request.contextPath}/ui/system-management/add-server" method="post">
                ...
                <input type="button" name="cancel" value="<spring:message code='theme.button.cancel.text' />" id="cancel" class="submit" onclick="redirectOnCancel('/esolutions/ui/system-management/default');" />
            </form:form>
        </p>
    </div>
</div>
