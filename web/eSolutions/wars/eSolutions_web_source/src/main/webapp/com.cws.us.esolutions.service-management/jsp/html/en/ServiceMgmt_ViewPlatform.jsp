...
<div id="main">
    ...
    <h1><strong><spring:message code="svc.mgmt.view.platform" arguments="${platform.platformName}" /></strong></h1>
    ...
    ${platform.status}
    <label id="txtPlatformRegion"><spring:message code="svc.mgmt.platform.region" /></label>
