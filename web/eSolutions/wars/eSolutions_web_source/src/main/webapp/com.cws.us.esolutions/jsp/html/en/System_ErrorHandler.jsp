...
<div id="content">
    <div id="content-right">
	    ...
	    <c:choose>
	        ...
	        <c:otherwise>
	            <p><a href="${pageContext.request.contextPath}/ui/login/default" title="<spring:message code='theme.navbar.login' />"><spring:message code="text.click.continue" arguments="${pageContext.request.contextPath}/ui/login/default" /></a></p>
	        </c:otherwise>
	    </c:choose>
    </div>
</div>
