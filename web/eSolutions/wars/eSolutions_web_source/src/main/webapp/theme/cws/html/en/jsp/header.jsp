...
<html xml:lang="en" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <head>
        ...
        <meta http-equiv="refresh" content="900; ${pageContext.request.contextPath}/logout" />
        ...
        <script type="text/javascript">
            <!--
                ...
                var ignoreURIs = new Array("/login", "/logout", "/online-reset", "/common/submit-contact");
                ...
                for (var x = 0; x < ignoreURIs.length; x++)
                {
                    ...
                    {
                        setInterval(function() { window.location.href = '${pageContext.request.contextPath}/logout'; }, timeout);
                    }
                }
            //-->
        </script>
                    ...
                    <c:if test="${not empty fn:trim(sessionScope.userAccount)}">
                        <c:if test="${sessionScope.userAccount.status == 'SUCCESS'}">
                            <c:if test="${sessionScope.userAccount.role ne 'USERADMIN'}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/application-management/default" title="<spring:message code='theme.navbar.application-mgmt' />">
                                        <spring:message code='theme.navbar.application-mgmt' /></a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/dns-service/default" title="<spring:message code='theme.navbar.dns-services' />">
                                        <spring:message code='theme.navbar.dns-services' /></a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/service-management/default" title="<spring:message code='theme.navbar.service-mgmt' />">
                                        <spring:message code='theme.navbar.service-mgmt' /></a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/system-management/default" title="<spring:message code='theme.navbar.system-mgmt' />">
                                        <spring:message code='theme.navbar.system-mgmt' /></a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/service-messaging/default" title="<spring:message code='theme.navbar.messaging' />">
                            ...
                            <c:if test="${sessionScope.userAccount.role eq 'USERADMIN' or sessionScope.userAccount.role eq 'ADMIN' or sessionScope.userAccount.role eq 'SITEADMIN'}">
                                <li class="last">
                                    <a href="${pageContext.request.contextPath}/user-management/default" title="<spring:message code='theme.navbar.useradmin' />">
