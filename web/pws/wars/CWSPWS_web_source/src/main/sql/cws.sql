...
SOURCE ./cws.kbase.sql;
SOURCE ./cws.messaging.sql;
...
GRANT SELECT,INSERT,UPDATE,DELETE,EXECUTE ON `cws`.* TO 'appuser'@'127.0.0.1';
GRANT SELECT ON `mysql`.`proc` TO 'appuser'@'localhost';
GRANT SELECT ON `mysql`.`proc` TO 'appuser'@'127.0.0.1';
FLUSH PRIVILEGES;
COMMIT;
